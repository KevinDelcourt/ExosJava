...
public class AutomatonPackageImpl extends EPackageImpl implements AutomatonPackage {
	 ...
	 * @generated
	 */
	public EReference getTransition_Origine() {
	 ...
	 * @generated
	 */
	public EReference getAutomaton_State() {
	 ...
	 * @generated
	 */
	public EReference getAutomaton_Transition() {
	 ...
	 * @generated
	 */
	public EReference getAutomaton_Output() {
	 ...
	 * @generated
	 */
	public EReference getAutomaton_Input() {
	...
	public void createPackageContents() {
		...
		createEReference(transitionEClass, TRANSITION__ORIGINE);
		createEReference(transitionEClass, TRANSITION__DESTINATION);

		automatonEClass = createEClass(AUTOMATON);
		createEReference(automatonEClass, AUTOMATON__STATE);
		createEReference(automatonEClass, AUTOMATON__TRANSITION);
		createEReference(automatonEClass, AUTOMATON__OUTPUT);
		createEReference(automatonEClass, AUTOMATON__INPUT);
	...
	public void initializePackageContents() {
		...
		initEReference(getTransition_Action(), this.getOutput(), null, "action", null, 0, -1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Origine(), this.getState(), null, "origine", null, 0, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(automatonEClass, Automaton.class, "Automaton", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAutomaton_State(), this.getState(), null, "state", null, 0, -1, Automaton.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAutomaton_Transition(), this.getTransition(), null, "transition", null, 0, -1,
				Automaton.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAutomaton_Output(), this.getOutput(), null, "output", null, 0, -1, Automaton.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAutomaton_Input(), this.getInput(), null, "input", null, 0, -1, Automaton.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
